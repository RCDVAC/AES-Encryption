...
public class StateUtils {
    ...
    public static void invRotateStateRow(State state, int rowNum, int shiftNum) {
        byte first = state.getValue(rowNum, 0);
        byte second = state.getValue(rowNum, 1);
        byte third = state.getValue(rowNum, 2);
        byte fourth = state.getValue(rowNum, 3);

        int firstPosition = (0 + shiftNum) > 3 ? (0 + shiftNum) - 4 : 0 + shiftNum;
        int secondPosition = (1 + shiftNum) > 3 ? (1 + shiftNum) - 4 : 1 + shiftNum;
        int thirdPosition = (2 + shiftNum) > 3 ? (2 + shiftNum) - 4 : 2 + shiftNum;
        int fourthPosition = (3 + shiftNum) > 3 ? (3 + shiftNum) - 4 : 3 + shiftNum;
